<template>
    <div class="bg-[#F5F6F7] py-20 px-5">
        <h3 class="mx-auto text-center px-5 text-4xl md:text-5xl mb-10 font-bold">Recipe of The Moment <span>😉</span>
            <span>😟</span>
        </h3>
            ...
            <div class="flex-1">
                ...
                <div class=" justify-start">
                    <p class="text-green-900 mb-2 bg-green-50 border border-green-400 rounded-full w-fit px-5 py-1">
                        Instructions: </p>
                    <p class="text-lg">Esse mollit et eiusmod sint non cupidatat elit nulla cupidatat ea commodo
                        deserunt sunt nisi....</p>
                </div>
                <div class="mb-10 flex flex-wrap gap-5 mt-5">

                    <router-link :to="{ name: 'recipesCategories', params: { name: 'category-1' } }"
