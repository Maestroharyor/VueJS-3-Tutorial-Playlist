  ...
  <header class="hidden lg:block">
    <nav class="flex items-center justify-between py-5 px-10">
      ...
      <div class="relative">
        ...
        <div
          class="px-5 pt-2 pb-6 absolute top-[40px] left-0 bg-white rounded-b shadow-md w-[230px] z-[5] search_results"
        ...
        >
          ...
          <div
            class="flex flex-col gap-5 divide-y-2"
...
const closeModal = (e) => {
  if (!e.target.matches(".search_results")) {
    loading.value = false;
    searchResults.value = [];
  }
};
